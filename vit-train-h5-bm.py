...
from vit_core_h5_bm import class_labels
from vit_core_h5_bm import train_dataset
from vit_core_h5_bm import validation_dataset
from vit_core_h5_bm import image_dimensions
import os
                        ...
                        for vit_depth in vit_depth_options:
                            ...
                            for num_heads in num_heads_options:
                                ...
                                for mlp_dim in mlp_dims:
                                    ...
                                    # Instantiate the Simple ViT model with the current configuration.
                                    model = SimpleViT(
                                                    image_size=image_dimensions,  # Use the correct dimensions here
                                                    patch_size=16, # best 16 for (3,256,256) image
                                                    num_classes=num_classes,
                                                    dim=vit_dim, # best 768
                                                    depth=vit_depth, # best 14
                                                    heads=num_heads, # best 8
                                                    mlp_dim=mlp_dim # best 1024
                                                )
...
print(f'Batch Size = {best_hyperparameters[4]}')                        # 5
print(f'ViT depth = {best_hyperparameters[5]}')                         # 6
print(f'ViT dimension = {best_hyperparameters[6]}')                     # 7
print(f'Heads = {best_hyperparameters[7]}')                             # 8
print(f'MLP dimension = {best_hyperparameters[8]}\n')                   # 9
